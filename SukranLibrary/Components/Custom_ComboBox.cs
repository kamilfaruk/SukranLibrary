...
namespace SukranLibrary.Components
{
    ...
    class Custom_ComboBox : UserControl
    {
        //Fields
        private Color backColor = Color.Red;
        private Color iconColor = Color.FromArgb(202, 43, 77);
        private Color listBackColor = Color.FromArgb(64, 69, 76);
        private Color listTextColor = Color.FromArgb(192, 192, 192);
