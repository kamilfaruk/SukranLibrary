...
{
    public class Custom_DateTimePicker : DateTimePicker
    {
        //Fields
        //-> Appearance
        private Color skinColor = Color.FromArgb(64, 69, 76);
        private Color textColor = Color.FromArgb(192, 192, 192);
        private Color borderColor = Color.FromArgb(202, 43, 77);
        private int borderSize = 1;

        //-> Other Values
        private bool droppedDown = false;
        private Image calendarIcon = Properties.Resources.WhiteCalendar_Image;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.DarkCalendar_Image;
                else calendarIcon = Properties.Resources.WhiteCalendar_Image;
                this.Invalidate();
            }
        }
